...
<head>
    ...
    <!-- font-awesome -->
    <link href="{{ asset('resume1/css/font-awesome.min.css') }}" rel="stylesheet">

    <!-- Bootstrap -->
    <link href="{{ asset('resume1/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Style CSS -->
    <link href="{{ asset('resume1/css/style.css') }}" rel="stylesheet">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-117960088-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-117960088-1');
</script>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <a class="portfolio-item" href="#">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('resume1/img/portfolio-1.jpg') }}" alt="">
                    </div>
            ...
            <div class="col-md-6">
                <a class="portfolio-item" href="#">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('resume1/img/portfolio-2.jpg') }}" alt="">
                    </div>
            ...
            <div class="col-md-6">
                <a class="portfolio-item" href="#">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('resume1/img/portfolio-3.jpg') }}" alt="">
                    </div>
            ...
            <div class="col-md-6">
                <a class="portfolio-item" href="#">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('resume1/img/portfolio-4.jpg') }}" alt="">
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="feedback-form">
                    ...
                    @endif
                    {!! Form::open(['route'=>'contact_post', 'method'=>'POST', 'id'=>'contactForm']) !!}
                        ...
                        <div class="form-group">
                            {{ Form::label('bodymessage', 'Message', ['class'=>'control-label']) }}
                            {{ Form::textarea('bodymessage', null, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>'Write message', 'rows'=>'4']) }}
                        </div>
...
<!-- jquery -->
<script src="{{ asset('resume1/js/jquery-2.1.4.min.js') }}"></script>

<!-- Bootstrap -->
<script src="{{ asset('resume1/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('resume1/js/theia-sticky-sidebar.js') }}"></script>
<script src="{{ asset('resume1/js/scripts.js') }}"></script>
</body>
</html>